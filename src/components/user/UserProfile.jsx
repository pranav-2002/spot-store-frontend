      ...
      {userFormData.email.length > 0 ? (
        <div className="py-8 px-4 mx-auto max-w-2xl lg:py-16">
          ...
          <form onSubmit={handleEditUserDetails}>
            ...
            <Button
              type="submit"
              className="inline-flex items-center px-4 py-1.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800"
            >
              {isLoading ? (
                <>
                  <Spinner
